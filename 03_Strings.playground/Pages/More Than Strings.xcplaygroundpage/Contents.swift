...
let instructerName = "TJ"
let classLength = 3
let numberOfLessons = 3
let numberOfAssignments = 2
let todaysSummary = "In class today, \(instructerName) spent \(classLength) hours teaching us \(numberOfLessons) lessons and giving us \(numberOfAssignments) homework assignments"
