...
func isLeapYear(_ year: Int) -> Bool {
    if number(year, isDivisibleBy: 4) == true && number(year, isDivisibleBy: 100) == false {
        return true
    } else if number(year, isDivisibleBy: 4) == true && number(year, isDivisibleBy: 100) == true && number(year, isDivisibleBy: 400) == true {
        return true
    } else {
        return false
}
