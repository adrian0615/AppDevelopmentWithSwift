...
ricketyRope.canHandleAdditionalLoad(books)
ricketyRope.canHandleAdditionalLoad(books)
ricketyRope.canHandleAdditionalLoad(books)
ricketyRope.canHandleAdditionalLoad(games)
strongRope.canHandleAdditionalLoad(games)
strongRope.canHandleAdditionalLoad(games)
strongRope.canHandleAdditionalLoad(bikes)
