...
//playgroundsLeft, playgroundsDone,

func playgroundsLeftMessage(playgroundsDone: Int) -> String {
    let totalPlaygrounds = 19
    let playgroundsLeft = totalPlaygrounds - playgroundsDone
    
    return "If I completed \(playgroundsDone) playgrounds, then I have \(playgroundsLeft) playgrounds remaining"

}

playgroundsLeftMessage(playgroundsDone: 25)

print(playgroundsLeftMessage(playgroundsDone: 10))
