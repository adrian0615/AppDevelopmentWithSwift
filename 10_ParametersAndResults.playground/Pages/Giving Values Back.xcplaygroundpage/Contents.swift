...
print(makeFavorite(categoryOfThing: "movie", favorite: "Coming to America"))
...
let favoriteSeason = makeFavorite(categoryOfThing: "season", favorite: "spring")
let favoriteHoliday = makeFavorite(categoryOfThing: "holiday", favorite: "Christmas")
let favoriteMovie = makeFavorite(categoryOfThing: "movie", favorite: "Coming to America")
...
print("Hello, my name is Adrian. \(favoriteSeason). \(favoriteHoliday). \(favoriteMovie).")
