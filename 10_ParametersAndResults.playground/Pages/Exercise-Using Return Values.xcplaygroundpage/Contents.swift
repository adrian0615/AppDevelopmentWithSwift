...
impossibleBeliefsCount(pigsFlying: 5, frogsBecomingPrinces: 5, multipleLightningStrikes: 3)
...
print(impossibleThingsPhrase(numberOfImpossibleThings: 14, meal: "dinner"))
...
let numImpossible = impossibleBeliefsCount(pigsFlying: 4, frogsBecomingPrinces: 8, multipleLightningStrikes: 55)
print(impossibleThingsPhrase(numberOfImpossibleThings: numImpossible, meal: "Brunch"))
